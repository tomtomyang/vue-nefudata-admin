<template>
  <div>
    <div class="codeEditor-container">
      ...
      <codemirror ref="editQuerySQL" v-model="oracleSqlQuery" :options="codemirrorOptions" class="codeEditor-main"></codemirror>
    </div>
    <div>
...
export default {
  ...
  methods: {
    // sql格式化
    sqlFormat() {
      this.oracleSqlQuery=sqlFormatter.format(this.oracleSqlQuery)
    },
    // 提交sql到后台
    submitSqlQuery() {
